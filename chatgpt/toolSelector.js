...
const GROUP_RULES = [
    {
        ...
        patterns: [
            ...
            /как\s+у\s+нас/i,
            /как\s+принято/i,
            /где\s+(описан|написан|найти|посмотреть)/i,
            /что\s+делать\s+если/i,
        ],
    },
    {
        group: 'memory',
        patterns: [
            /запомни/i,
            /сохрани.{0,20}(контекст|данн|информац)/i,
            /запиши.{0,20}(контекст|данн|информац)/i,
        ],
    },
    {
        group: 'duty',
    ...
    },
    {
        ...
        patterns: [
            /приглас/i,
            /\binvite\b/i,
            /добав.{0,20}(канал|чат)/i,
            /в\s+канал/i,
            /в\s+чат/i,
            /фича-?чат/i,
            /этот\s+чат/i,
            /mchat\.pravo\.tech\/[^)\s]+\/channels\//i,
            /\/channels\//i,
            /\bc1_[a-z0-9_]+\b/i,
            /приватн/i,
