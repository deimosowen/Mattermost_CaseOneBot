...
const CalendarCronService = require('./calendarCronService');
const ReviewManagerCronService = require('./reviewManagerCronService');
...
class CronManager {
    constructor() {
        ...
        this._register(new CalendarCronService());
        this._register(new ReviewManagerCronService());
    }
