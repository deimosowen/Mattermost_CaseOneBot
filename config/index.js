module.exports = {
    ...
    CONFLUENCE_SPACE_KEYS: process.env.CONFLUENCE_SPACE_KEYS ? process.env.CONFLUENCE_SPACE_KEYS.split(",").map(space => space.trim()).filter(Boolean) : [],
    KNOWLEDGE_SEARCH_LIMIT: parseInt(process.env.KNOWLEDGE_SEARCH_LIMIT || '5', 10) || 5,
    ...
    AUTO_RESOLVE_CONFLICTS: process.env.AUTO_RESOLVE_CONFLICTS === 'true',
    GITLAB_WEBHOOK_SECRET: process.env.GITLAB_WEBHOOK_SECRET || '',
    USE_GITLAB_WEBHOOK: process.env.USE_GITLAB_WEBHOOK === 'true',
    WORKLOG_REPORT_TEMPO_TIMEOUT_MS: parseInt(process.env.WORKLOG_REPORT_TEMPO_TIMEOUT_MS || '60000', 10) || 60000,
    WORKLOG_REPORT_TEMPO_USER_CONCURRENCY: parseInt(process.env.WORKLOG_REPORT_TEMPO_USER_CONCURRENCY || '6', 10) || 6,
    FLAKY_TEST_MONITORING_ENABLED: process.env.FLAKY_TEST_MONITORING_ENABLED !== 'false',
    FLAKY_STABILIZATION_TASK_KEY: process.env.FLAKY_STABILIZATION_TASK_KEY || 'CASEM-93785',
    FLAKY_JIRA_PROJECT_KEY: process.env.FLAKY_JIRA_PROJECT_KEY || 'CASEM',
    FLAKY_JIRA_ISSUE_TYPE_ID: process.env.FLAKY_JIRA_ISSUE_TYPE_ID || '3',
    FLAKY_JIRA_EPIC_LINK_FIELD: process.env.FLAKY_JIRA_EPIC_LINK_FIELD || 'customfield_11161',
    FLAKY_MIN_CONFIDENCE: Number(process.env.FLAKY_MIN_CONFIDENCE || '0.55'),
};
